...
const allHappy = (arr) => {
  return arr.reduce((answerSoFar, value) => answerSoFar && value.includes(':)'),true);
};
...
const findEvery = (arr, target) => {
  return arr.reduce((answerSoFar, value) => answerSoFar && value.includes(target), true);
};
